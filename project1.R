...
## Create Graph Number 2: Plot 1
plot(graphData$Global_active_power~graphData$dateTime, type ="l", ylab = "Global Active Power (kilowatts)",
     xlab="")
dev.copy(png, "c:/users/jbwhe/documents/GIT repositories/ExData_Plotting1/plot2.png", width = 480, height=480)
dev.off()

## Create Graph Number 3: Plot 2
with(graphData, {
...
dev.copy(png, "c:/users/jbwhe/documents/GIT repositories/ExData_Plotting1/plot3.png", width = 480, height=480)
dev.off()
